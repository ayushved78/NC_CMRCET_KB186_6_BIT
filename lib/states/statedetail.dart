...
class _stateDetailsState extends State<stateDetails> {
  ...
  call(){
    String phoneno = "tel:"+widget.state_phn;
    launch(phoneno);
  }

  mail(){
    String mailID = "mailto:"+widget.state_eml;
    launch(mailID);
  }

  openURL() {
    String url1 = "https://wa.link/gf7oxd";
    launch(url1);
  }
              ...
              SizedBox(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      "We will fight together this cyber war, just report the cyber case to the state cyber team by just tapping on the button provided below. We are there to protect you!!",
                      style: TextStyle(
                        fontSize: 30.0,
                        fontWeight: FontWeight.bold,
                      ),
                ...
                child: Row(
                  children: <Widget>[
                    Card(
                      color: Colors.green,
                      child: IconButton(
                        icon: Icon(Icons.phone,color: Colors.white,size: 25.0,),
                        tooltip: widget.state_phn,
                        onPressed: (){
                          //canLaunch('tel: $widget.state_phn');
                          call();
                        },
                      ),
                    ),
                    Card(
                      ...
                      child: IconButton(
                        icon: Icon(Icons.email,size: 25.0,color: Colors.white,),
                        tooltip: widget.state_eml,
                        onPressed: (){
                          //canLaunch('mailto: widget.state_eml');
                          mail();
                        },
                      ),
                    ),
                    Card(
                      ...
                      child: GestureDetector(
                        onTap: (){},
                        child: IconButton(
                          icon: Icon(FontAwesomeIcons.whatsapp,color: Colors.white,size: 25.0,),
                          tooltip: 'Dept WhatsApp no.',
                          onPressed: (){
                            //canLaunch('https://api.whatsapp.com/send?phone=919087200100');
                            //canLaunch("https://api.whatsapp.com/send?phone=919087200100");
                            openURL();
                          },
                        ),
